...
class EventFactory extends Factory
{
    public function definition(): array
    {
        ...
        // Use provided category or random one
        $category = $this->faker->optional(0.8)->randomElement(array_keys($eventTypes)) ?? 'league_match';
        
        // If category is provided in the factory call, use it
    ...
    /**
     * Create a league match event
     */
    public function leagueMatch(): static
    {
        return $this->state(function (array $attributes) {
            ...
            $title = $this->faker->randomElement($eventTypes['league_match']['titles']);
            $description = $this->faker->randomElement($eventTypes['league_match']['descriptions']);
    ...
    /**
     * Create a cup match event
     */
    public function cupMatch(): static
    {
        return $this->state(function (array $attributes) {
            $eventTypes = [
                'cup_match' => [
            ...
            $title = $this->faker->randomElement($eventTypes['cup_match']['titles']);
            $description = $this->faker->randomElement($eventTypes['cup_match']['descriptions']);
    ...
    public function friendly(): static
    {
        return $this->state(function (array $attributes) {
            ...
            $title = $this->faker->randomElement($eventTypes['friendly']['titles']);
            $description = $this->faker->randomElement($eventTypes['friendly']['descriptions']);
    ...
    public function training(): static
    {
        return $this->state(function (array $attributes) {
            ...
            $title = $this->faker->randomElement($eventTypes['training']['titles']);
            $description = $this->faker->randomElement($eventTypes['training']['descriptions']);
    ...
    public function tournament(): static
    {
        return $this->state(function (array $attributes) {
            ...
            $title = $this->faker->randomElement($eventTypes['tournament']['titles']);
            $description = $this->faker->randomElement($eventTypes['tournament']['descriptions']);
